...
const menuGroups = [
  {
    ...
    menuItems: [
      // dashboard
      {
        ...
        label: "Dashboard",
        route: "#",
        children: [{ label: "Student", route: "/" }, { label: "Mark Attendence", route: "/attendence" },],
      },
      // Calendar
      // {
      //   icon: (
      ...
      // course
      {
        ...
        route: "#",
        children: [
          { label: "Front-end Course", route: "/courses/front-end" },
          { label: "Back-end Course", route: "/courses/back-end" },
        ],
      },
      //books
      {
        icon: (
          <svg fill="white" height="18px" width="18px" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"
      ...
      // QUIZ
      {
        ...
        route: "#",
        children: [
          // { label: "Practice Quiz", route: "/quiz/practice" },
          { label: "Hemskar Quiz", route: "/quiz/quiz" },
        ],
      },
      // announcement
      {
        icon: (
          <svg fill="white" width="18px" height="18px" viewBox="0 0 1920 1920" xmlns="http://www.w3.org/2000/svg">
